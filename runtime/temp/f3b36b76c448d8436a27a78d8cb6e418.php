<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:77:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\index\index.html";i:1540277417;s:77:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\base.html";i:1539158298;s:85:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_load_t.html";i:1539158298;s:82:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_top.html";i:1540522655;s:83:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_left.html";i:1540532309;s:85:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_bottom.html";i:1540458843;s:85:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_load_b.html";i:1539158298;}*/ ?>
...
<section class="content">
    <div class="alert alert-danger">
        ...
        <p>您好，欢迎您的到来！系统使用TP：5.0.10，如果使用中有什么BUG或需要优化，欢迎在下面的<i>系统反馈</i>中留言。欢迎加入QQ群：184278846</p>
    </div>
    
    <div class="row">
        <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="small-box bg-yellow">
                <div class="inner"><h3><?php echo $userTotal; ?></h3><p>后台用户数</p></div>
                <div class="icon" style=""><i class="fa fa-users" style="margin-top: 10px;"></i></div>
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="small-box bg-green">
                <div class="inner"><h3><?php echo $applyTotal; ?></h3><p>报名总数</p></div>
                <div class="icon"><i class="fa fa-file-text" style="margin-top: 10px;"></i></div>
                <a href="<?php echo url('apply/index'); ?>" class="small-box-footer"><?php echo \think\Lang::get('more'); ?> <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="small-box bg-aqua">
                ...
                <a href="<?php echo url('UserinfoMechanism/user_list'); ?>" class="small-box-footer"><?php echo \think\Lang::get('more'); ?> <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="small-box bg-red">
                <div class="inner"><h3><?php echo $feedbackTotal; ?></h3><p>用户反馈</p></div>
                <div class="icon"><i class="fa fa-commenting"></i></div>
                <a href="<?php echo url('feedback/index'); ?>" class="small-box-footer"><?php echo \think\Lang::get('more'); ?> <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
