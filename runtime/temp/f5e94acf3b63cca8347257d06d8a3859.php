<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:94:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\userinfo_mechanism\user_list.html";i:1539158298;s:77:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\base.html";i:1539158298;s:85:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_load_t.html";i:1539158298;s:82:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_top.html";i:1540522655;s:83:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_left.html";i:1540532309;s:79:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\search.html";i:1539158298;s:85:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_bottom.html";i:1540458843;s:85:"F:\PHPTutorial\WWW\jing_sai\public/../application/admin\view\public\admin_load_b.html";i:1539158298;}*/ ?>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border"><h3 class="box-title"></h3>
                    <div class="pull-left">
                        <?php echo authAction(CONTROLLER_NAME.'/user_edit', 'create'); ?>
                        <?php echo authAction(CONTROLLER_NAME.'/user_del', 'delete_all'); ?>
                    </div>
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered table-hover table-sort">
                        <tr>
                            ...
                            <th>头像</th>
                            <th>昵称</th>
                            <th>手机<?php echo table_sort('phone'); ?></th>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align:middle"><img src="<?php echo $vo['avatar']; ?>" style="width:50px;border-radius:50%;" /></td>
                            <td style="vertical-align:middle"><?php echo $vo['username']; ?></td>
                            <td style="vertical-align:middle"><?php echo $vo['phone']; ?></td>
                            <td style="vertical-align:middle">
                                <a class="btn btn-primary btn-xs" href="<?php echo url('Sysmsg/edit', ['uid'=>$vo['id']]); ?>">添加消息</a>
                                <?php echo authAction(CONTROLLER_NAME.'/user_edit', 'edit', ['id' => $vo['id']]); ?>
                                <?php echo authAction(CONTROLLER_NAME.'/user_del', 'delete', $vo['id']); ?>
                            </td>
                        </tr>
